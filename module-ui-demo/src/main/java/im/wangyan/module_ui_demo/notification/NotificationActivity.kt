...
import im.wangyan.module_ui_demo.databinding.ActivityNotificationBinding
...
class NotificationActivity : BaseActivity<ActivityNotificationBinding>() {
    ...
    private fun createNotificationForNormal() {
        ...
        mBuilder = NotificationCompat.Builder(this@NotificationActivity, mNormalChannelId)
            ...
            .setLargeIcon(BitmapFactory.decodeResource(resources, R.drawable.ic_avatar)) // 大图标
    ...
    private fun createNotificationForHigh() {
        ...
        mBuilder = NotificationCompat.Builder(this@NotificationActivity, mHighChannelId)
            ...
            .addAction(R.drawable.ic_avatar, "去看看", pendingIntent)// 通知上的操作
    ...
    private fun createNotificationForCustom() {
        ...
        val pendingIntentStop =
            PendingIntent.getBroadcast(this@NotificationActivity, 0, intentStop, mFlag)
        views.setOnClickPendingIntent(R.id.btn_stop, pendingIntentStop)

        // 添加完成事件
        val intentDone = Intent(mDoneAction)
        val pendingIntentDone =
            PendingIntent.getBroadcast(this@NotificationActivity, 0, intentDone, mFlag)
