package im.wangyan.module_ui_demo.shapeable_imageview
...
import im.wangyan.module_ui_demo.databinding.ActivityShapeableImageViewBinding
...
class ShapeableImageViewActivity : BaseActivity<ActivityShapeableImageViewBinding>() {
    ...
    override fun initView() {
        ...
        val drawable2 = MaterialShapeDrawable(shapeAppearanceModel2).apply {
            ...
            strokeWidth = 50f
            strokeColor =
                ContextCompat.getColorStateList(this@ShapeableImageViewActivity, R.color.red)
        }
