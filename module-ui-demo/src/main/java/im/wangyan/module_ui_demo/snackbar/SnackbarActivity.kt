package im.wangyan.module_ui_demo.snackbar
...
import im.wangyan.module_ui_demo.databinding.ActivitySnackbarBinding

class SnackbarActivity : BaseActivity<ActivitySnackbarBinding>() {
    ...
    override fun initView() {
        ...
        mBinding.button2.setOnClickListener {
            val mSnackbar =
                Snackbar.make(mBinding.constraintLayout, "已加入行程", Snackbar.LENGTH_INDEFINITE)
            //设置Action并监听事件
        ...
        mBinding.button3.setOnClickListener {
            val mSnackbar1 =
                Snackbar.make(mBinding.constraintLayout, "已加入行程", Snackbar.LENGTH_INDEFINITE)
            //设置Snackbar的背景颜色
            mSnackbar1.view.setBackgroundColor(
